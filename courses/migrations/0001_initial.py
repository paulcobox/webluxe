# Generated by Django 5.0.6 on 2024-07-07 04:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('video', models.FileField(blank=True, upload_to='videos/course', verbose_name='Video')),
                ...
                ('type', models.CharField(choices=[('Virtual', 'Virtual'), ('Presencial', 'Presencial'), ('Grabada', 'Grabada')], max_length=50, verbose_name='Tipo')),
                ('created_date', models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Creación')),
                ('modified_date', models.DateTimeField(auto_now=True, verbose_name='Fecha de Modificación')),
                ('instructor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course', to='aboutus.instructors', verbose_name='Profesor')),
            ],
            options={
                'verbose_name': 'Curso',
