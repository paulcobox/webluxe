...
class Instructors(models.Model):
      ...
      image_top = models.ImageField(blank=True, upload_to='images', verbose_name = "Imagen Banner Top")
      ...
      facebook = models.URLField(max_length=500, blank = False, null = False, verbose_name = "Facebook")
      tiktok = models.URLField(max_length=500, blank = False, null = False, verbose_name = "Tiktok")
      instagram = models.URLField(max_length=500, blank = False, null = False, verbose_name = "Instagram")
      youtube = models.URLField(max_length=500, blank = False, null = False, verbose_name = "Youtube")
